...
sealed class AppRoutes(val route: String) {
    ...
    data class SessionSummary(val sessionId: Long) : AppRoutes("session_summary/{sessionId}") {
    ...
    data class SessionDetail(val sessionId: Long) : AppRoutes("session_detail/{sessionId}") {
