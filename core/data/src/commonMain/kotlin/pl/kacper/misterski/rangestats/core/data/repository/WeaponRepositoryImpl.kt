...
class WeaponRepositoryImpl(
    ...
    override suspend fun getAllWeapons(): List<Weapon> = weaponDataSource.getAllWeapons().map { it.toDomain() }

    override suspend fun getWeaponByName(name: String): Weapon? = weaponDataSource.getWeaponByName(name)?.toDomain()
